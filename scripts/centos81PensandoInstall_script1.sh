...
echolog "$(tput setaf 4) $(tput setab 7)Reboot before proceeding.................................$(tput sgr 0)"
echolog "$(tput setaf 4) $(tput setab 7)Proceed with next script after the reboot................$(tput sgr 0)"
